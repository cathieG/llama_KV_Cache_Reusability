...
def expand_kv_dim(x: torch.Tensor, method: str) -> torch.Tensor:
    if method == "duplication":
        ...
        x_reshaped = x.reshape(b * h * s, 1, d)
        ...
        return x_interp.reshape(b, h, s, d * 2)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--method", required=True, choices=["zero_padding", "duplication", "interpolation"])
